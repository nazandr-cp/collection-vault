...
contract StressTest is RewardsController_Test_Base {
    ...
    function setUp() public override {
        ...
        for (uint256 i = 0; i < NUM_COLLECTIONS; i++) {
            MockERC721 mockNFT = new MockERC721(string(abi.encodePacked("Mock NFT ", i.toString())), string(abi.encodePacked("MNFT", i.toString())));
    ...
    function test_StressTest_MultiCollectionManyUsers() public {
        ...
        gasUsed = gasStart - gasleft();
        console.log("Gas used to sync %d users across %d collections: %d", 
            NUM_USERS, NUM_COLLECTIONS, gasUsed);
