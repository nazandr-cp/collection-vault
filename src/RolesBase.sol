...
/**
 * @title RolesBase
 * @dev Unified base contract providing standardized access control, pausability, and reentrancy protection
 * @dev Combines AccessControlBase and AccessControlModifiers functionality with unified onlyRoleOrGuardian pattern
 */
abstract contract RolesBase is AccessControlEnumerable, ReentrancyGuard, Pausable {
